...
namespace PrisonerTroopConstruction
{
    public class Settings : AttributeGlobalSettings<Settings>
    {
        ...
        [SettingPropertyBool("Engineer Bonus", IsToggle = true, Order = 3, RequireRestart = false)]
        [SettingPropertyGroup("Engineer Bonus")]
        public bool EngineerBonusEnable { get; set; } = true;
        
        [SettingPropertyFloatingInteger("Construction Bonus Per Skill Point", 0, 1, HintText = "The amount of bonus construction points per skill point your parties assigned engineer has.", Order = 4, RequireRestart = false)]
        [SettingPropertyGroup("Engineer Bonus")]
        public float BricksPerEngineerSkillPoint { get; set; } = 0.25f;

        [SettingPropertyBool("Prisoner Construction Bonus", IsToggle = true, Order = 5, RequireRestart = false)]
        [SettingPropertyGroup("Prisoner Construction")]
        public bool PrisonerConstructionEnable { get; set; } = true;

        [SettingPropertyFloatingInteger("Prisoner Tier Multiplier", 0, 1, HintText = "Multiplies Troop Tier * 0.25 * This Number. This will significantly increase or decrease the bonus given.", Order = 6, RequireRestart = false)]
        [SettingPropertyGroup("Prisoner Construction")]
        ...
        public override string FolderName => "ConstructionBonuses";
